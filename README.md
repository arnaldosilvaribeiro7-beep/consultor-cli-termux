...
5. Exibe identificação, situação cadastral, CNAEs, QSA público retornado pela fonte, porte, capital social, endereço comercial, contatos empresariais e dados postais complementares.
...
O projeto não busca CPF, telefone pessoal, e-mail pessoal, moradores, vizinhos, redes sociais, vazamentos, histórico de localização, processos de pessoas físicas ou bases privadas. O QSA é exibido somente quando a fonte pública de CNPJ o retorna como dado empresarial, sem tentar descobrir informações adicionais sobre os sócios.
